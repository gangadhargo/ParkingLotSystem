...
/**
 * Class to initialize to Mall Parking with parking floors, parking spots and pricing model
 * */
@SuperBuilder
@Data
public class MallParking extends ParkingFactory {
	@Override
	public Parking createParking() {
		List<ParkingFloor> parkingFloors = createParkingSpots();
		PricingModel pricingModel = new MallParkingPricingModel();

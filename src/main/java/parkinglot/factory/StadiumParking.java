...
import parkinglot.pricing.StadiumParkingPricingModel;
import parkinglot.service.Parking;
import parkinglot.service.ParkingLot;


/**
 * Class to initialize to Stadium Parking with parking floors, parking spots and pricing model
 * */
@SuperBuilder
@Data
public class StadiumParking extends ParkingFactory {
	@Override
	public Parking createParking() {
		List<ParkingFloor> parkingFloors = createParkingSpots();
		PricingModel pricingModel = new StadiumParkingPricingModel();
